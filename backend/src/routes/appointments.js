...
// Single round-trip: Prisma rewrites the include into a JOIN-equivalent
// batched query, eliminating the previous 1 + 2N pattern. `select` keeps the
// payload small — we only ship fields the client renders.
